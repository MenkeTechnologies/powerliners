...
| [x] | `powerline/segments/common/wthr.py` ↔ `src/ported/segments/common/wthr.rs` | 198 | 0 | 1 | 4 | 434 | 11 | 118 |
...
| [x] | `powerline/segment.py` ↔ `src/ported/segment.rs` | 399 | 9 | 0 | 0 | 1232 | 18 | 268 |
...
| [x] | `powerline/bindings/config.py` ↔ `src/ported/bindings/config.rs` | 232 | 11 | 1 | 2 | 698 | 25 | 179 |
